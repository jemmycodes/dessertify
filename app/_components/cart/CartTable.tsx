...
const CartTable = ({ cart }: { cart: Cart[] }) => {
  return (
    <section
      className={`md:w-[60%] w-full  overflow-scroll scrollbar-hide ${
        cart.length > 0 ? "h-[70vh] md:h-[85vh] " : "h-screen"
      }`}>
      <div className="flex flex-col w-full max-w-3xl gap-4 p-4 mx-auto md:py-16 md:px-10">
